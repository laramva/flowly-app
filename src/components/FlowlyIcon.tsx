// src/components/FlowlyIcon.tsx
import React from "react";
import { Image, ImageStyle } from "react-native";

export type FlowlyIconName =
  | "calendario"
  | "categorias"
  | "criar"
  | "dashboard"
...
const icons: Record<FlowlyIconName, any> = {
...
export default function FlowlyIcon({ name, size = 40, style }: Props) {
